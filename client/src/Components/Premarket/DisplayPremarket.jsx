      ...
      return (
        <div style={style}>
          <div ref={ref} className="px-4 pb-4">
            <div className="border border-gray-700 p-5 rounded-lg bg-gray-800 hover:bg-gray-800/70 transition-all shadow-sm group relative">
      ...
      <div className="bg-gray-800 p-4 rounded-lg border border-gray-700 shadow-lg">
        ...
        <div className="flex flex-wrap items-end gap-4">
          <div className="flex-1 min-w-[200px]">
            <label className="block text-gray-300 mb-1 text-sm font-medium">Start Date:</label>
            <DatePicker
          ...
          <div className="flex-1 min-w-[200px]">
            <label className="block text-gray-300 mb-1 text-sm font-medium">End Date:</label>
            <DatePicker
          ...
          <button
            ...
            className="flex items-center gap-2 bg-gray-700 hover:bg-gray-600 px-4 py-2 rounded-md transition-colors disabled:opacity-50 cursor-pointer"
          >
            <FiX />
            Clear Filters
          </button>
      ...
      <div className="bg-gray-800/50 rounded-lg border border-gray-700 overflow-hidden">
        <div className="h-[calc(100vh-300px)] p-4">
          {filteredPlans.length === 0 ? (
            <div className="text-center py-12 border border-dashed border-gray-700 h-full flex flex-col items-center justify-center rounded-lg">
            ...
            <AutoSizer>
              {({ height, width }) => (
                <List
                  ...
                  itemKey={(index) => filteredPlans[index]._id} // <-- important for proper diffing
                >
                  {Row}
                </List>
